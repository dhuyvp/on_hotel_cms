...
func GetColumnsAndValuesChannelListManage(p models.ChannelListManage) (string, string) {
...
func GetQueryUpdateChannelListManage(p models.ChannelListManage) string {
	var myMap map[string]interface{}
	data, _ := json.Marshal(p)
	json.Unmarshal(data, &myMap)
